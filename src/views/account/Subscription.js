...
class Subscription extends React.Component {
  ...
  componentDidMount() {
    this.stripeCheckout = window.StripeCheckout.configure({
      ...
      name: 'SpiritualGifts',
      description: 'Subscribe to SpiritualGifts',
  ...
  render() {
    return <SpiritualGiftsSubscription>
      { ({error, isLoading, subscription}) => {
        ...
        const cancelConfirmation = `Are you sure you want to cancel your subscription? You won't have access to paid SpiritualGifts features.`
